...
Patch199: 00199-sqlite3_int64.patch
...
%patch195 -p1
#renamed from 165 due to conflict when 2.7.4 updated to 2.7.5
#renamed again from 195 to 199 when 2.7.7 updated to 2.7.8
%patch199 -p1 -R
...
%else
  EXTRATESTOPTS="-x test_gdb --verbose"
%endif
...
#dump debug libs here because no debuginfo package
%{_prefix}/lib/debug
...
%changelog
* Thu Aug 21 2014 Karsten Hopp <karsten@redhat.com> 2.7.8-4.1
